...
$hesk_settings['hesk_title']='EasyDesk';
...
$hesk_settings['admin_css_url']='http://localhost/hesk/css/style.css';
...
$hesk_settings['db_pass']='satya@11';
...
$hesk_settings['url_key']='HBdBraqpJRt8pjt1E.uyq';
...
// --> Email sending
$hesk_settings['noreply_mail']='no-reply@shipeasy.tech';
$hesk_settings['noreply_name']='EasyDesk';
$hesk_settings['email_formatting']=3;
$hesk_settings['smtp']=1;
$hesk_settings['smtp_host_name']='smtp.hostinger.com';
$hesk_settings['smtp_host_port']=465;
$hesk_settings['smtp_timeout']=20;
$hesk_settings['smtp_enc']='ssl';
$hesk_settings['smtp_noval_cert']=0;
$hesk_settings['smtp_user']='no-reply@shipeasy.tech';
$hesk_settings['smtp_password']='Rajarani22@';
...
$hesk_settings['imap_host_name']='imap.hostinger.com';
$hesk_settings['imap_host_port']=993;
$hesk_settings['imap_enc']='ssl';
$hesk_settings['imap_noval_cert']=0;
$hesk_settings['imap_keep']=0;
$hesk_settings['imap_user']='help@shipeasy.tech';
$hesk_settings['imap_password']='Shipeasy@11';
